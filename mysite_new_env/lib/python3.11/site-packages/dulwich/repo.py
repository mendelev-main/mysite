...
from typing import TYPE_CHECKING, BinaryIO, Callable, Dict, FrozenSet, Iterable, List, Optional, Set, Tuple, Union
...
from .refs import LOCAL_BRANCH_PREFIX  # noqa: F401
from .refs import (
...
class Repo(BaseRepo):
    ...
    def stage(
        ...
        from .index import _fs_to_tree_path, blob_from_path_and_stat, index_entry_from_directory, index_entry_from_stat
    ...
    def reset_index(self, tree: Optional[bytes] = None):
        ...
        """
        from .index import build_index_from_tree, symlink, validate_path_element_default, validate_path_element_ntfs
