...
from poetry.core.constraints.version import Version, VersionRange, parse_marker_version_constraint
...
def create_nested_marker(
    ...
    from poetry.core.constraints.generic import Constraint, MultiConstraint, UnionConstraint
